package io.openems.edge.battery.huawei;
...
import io.openems.edge.battery.huawei.enums.BmsState;
import io.openems.edge.battery.huawei.enums.State;
...
public class HuaweiBatteryImpl extends AbstractOpenemsModbusComponent implements HuaweiBattery, Battery, ModbusComponent, OpenemsComponent, EventHandler, ModbusSlave, StartStoppable {

	private static final Integer OPEN_CONTACTORS = 0;
	private static final Integer CLOSE_CONTACTORS = 4;

	private final Logger log = LoggerFactory.getLogger(HuaweiBatteryImpl.class);
	...
	public HuaweiBatteryImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				Battery.ChannelId.values(), //
				StartStoppable.ChannelId.values(), //
				HuaweiBattery.ChannelId.values() //
		);
	}
	...
	private void clearError() {
		BooleanWriteChannel clearErrorChannel = this.channel(HuaweiBattery.ChannelId.BMS_STATE_COMMAND_CLEAR_ERROR);
		try {
	...
	private boolean isSystemRunning() {
		EnumReadChannel bmsStateChannel = this.channel(HuaweiBattery.ChannelId.BMS_STATE);
	...
	private void startSystem() {
		...
		IntegerWriteChannel commandChannel = this.channel(HuaweiBattery.ChannelId.BMS_STATE_COMMAND);
		try {
	...
	private void setStateMachineState(State state) {
		this.state = state;
		this.channel(HuaweiBattery.ChannelId.STATE_MACHINE).setNextValue(this.state);
	}
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		...
		return new ModbusProtocol(this, //
				...
				new FC16WriteRegistersTask(1399, //
						m(HuaweiBattery.ChannelId.HEART_BEAT, new UnsignedWordElement(1399)), //
						m(HuaweiBattery.ChannelId.BMS_STATE_COMMAND, new UnsignedWordElement(1400)), //
						m(HuaweiBattery.ChannelId.OPERATING_STATE_INVERTER, new UnsignedWordElement(1401)), //
						m(HuaweiBattery.ChannelId.DC_LINK_VOLTAGE, new UnsignedWordElement(1402), SCALE_FACTOR_MINUS_1), //
						m(HuaweiBattery.ChannelId.DC_LINK_CURRENT, new UnsignedWordElement(1403)), //
						m(HuaweiBattery.ChannelId.OPERATION_MODE_REQUEST_GRANTED, new UnsignedWordElement(1404)), //
						m(HuaweiBattery.ChannelId.OPERATION_MODE_REQUEST_CANCELED, new UnsignedWordElement(1405)), //
						m(new BitsWordElement(1406, this) //
								.bit(1, HuaweiBattery.ChannelId.CONNECTION_STRATEGY_HIGH_SOC_FIRST) //
								.bit(0, HuaweiBattery.ChannelId.CONNECTION_STRATEGY_LOW_SOC_FIRST) //
						), //
						m(HuaweiBattery.ChannelId.SYSTEM_TIME, new UnsignedDoublewordElement(1407)) //
				),

				new FC4ReadInputRegistersTask(999, Priority.HIGH,
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.LIFE_SIGN, new UnsignedWordElement(999)),
						m(HuaweiBattery.ChannelId.BMS_STATE, new UnsignedWordElement(1000)), //
						m(HuaweiBattery.ChannelId.ERROR_BITS_1, new UnsignedWordElement(1001)), //
						m(HuaweiBattery.ChannelId.ERROR_BITS_2, new UnsignedWordElement(1002)), //
						m(HuaweiBattery.ChannelId.WARNING_BITS_1, new UnsignedWordElement(1003)), //
						m(HuaweiBattery.ChannelId.WARNING_BITS_2, new UnsignedWordElement(1004)), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.INFO_BITS, new UnsignedWordElement(1005)),
						m(HuaweiBattery.ChannelId.MAXIMUM_OPERATING_CURRENT, new SignedWordElement(1006)), //
						m(HuaweiBattery.ChannelId.MINIMUM_OPERATING_CURRENT, new SignedWordElement(1007)), //
						...
						m(HuaweiBattery.ChannelId.MAXIMUM_LIMIT_DYNAMIC_VOLTAGE, new UnsignedWordElement(1012),
								SCALE_FACTOR_MINUS_1), //
						m(HuaweiBattery.ChannelId.MINIMUM_LIMIT_DYNAMIC_VOLTAGE, new UnsignedWordElement(1013),
								SCALE_FACTOR_MINUS_1), //
						m(HuaweiBattery.ChannelId.NUMBER_OF_STRINGS_CONNECTED, new UnsignedWordElement(1014)), //
						m(HuaweiBattery.ChannelId.NUMBER_OF_STRINGS_INSTALLED, new UnsignedWordElement(1015)), //
						m(HuaweiBattery.ChannelId.SOC_ALL_STRINGS, new UnsignedWordElement(1016), SCALE_FACTOR_MINUS_2), //
						m(Battery.ChannelId.SOC, new UnsignedWordElement(1017), SCALE_FACTOR_MINUS_2), //
						m(HuaweiBattery.ChannelId.REMAINING_CHARGE_CAPACITY, new UnsignedWordElement(1018)), //
						m(HuaweiBattery.ChannelId.REMAINING_DISCHARGE_CAPACITY, new UnsignedWordElement(1019)), //
						m(HuaweiBattery.ChannelId.REMAINING_CHARGE_ENERGY, new UnsignedWordElement(1020)), //
						m(HuaweiBattery.ChannelId.REMAINING_DISCHARGE_ENERGY, new UnsignedWordElement(1021)), //
						m(HuaweiBattery.ChannelId.NOMINAL_ENERGY, new UnsignedWordElement(1022)), //
						m(HuaweiBattery.ChannelId.TOTAL_ENERGY, new UnsignedWordElement(1023)), //
						m(HuaweiBattery.ChannelId.NOMINAL_CAPACITY, new UnsignedWordElement(1024)), //
						...
						m(HuaweiBattery.ChannelId.DC_VOLTAGE_AVERAGE, new UnsignedWordElement(1028),
								SCALE_FACTOR_MINUS_1)), //
				new FC4ReadInputRegistersTask(1029, Priority.HIGH, //
						m(new SignedWordElement(1029)) //
								.m(HuaweiBattery.ChannelId.DC_CURRENT, SCALE_FACTOR_MINUS_1) //
								.m(Battery.ChannelId.CURRENT, SCALE_FACTOR_MINUS_1) //
								.build()), //
				new FC4ReadInputRegistersTask(1030, Priority.HIGH, //
						m(HuaweiBattery.ChannelId.AVERAGE_TEMPERATURE, new SignedWordElement(1030))), //
				new FC4ReadInputRegistersTask(1031, Priority.HIGH, //
						m(new SignedWordElement(1031)) //
								.m(HuaweiBattery.ChannelId.MINIMUM_TEMPERATURE, DIRECT_1_TO_1) //
				...
				new FC4ReadInputRegistersTask(1032, Priority.HIGH, //
						m(new SignedWordElement(1032)) //
								.m(HuaweiBattery.ChannelId.MAXIMUM_TEMPERATURE, DIRECT_1_TO_1) //
				...
				new FC4ReadInputRegistersTask(1033, Priority.HIGH,
						...
						m(HuaweiBattery.ChannelId.AVERAGE_CELL_VOLTAGE, new UnsignedWordElement(1035)), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.INTERNAL_RESISTANCE, new UnsignedWordElement(1036)),
						m(HuaweiBattery.ChannelId.INSULATION_RESISTANCE, new UnsignedWordElement(1037), DIRECT_1_TO_1), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.CONTAINER_TEMPERATURE, new UnsignedWordElement(1038),
								SCALE_FACTOR_MINUS_1),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.AMBIENT_TEMPERATURE, new UnsignedWordElement(1039),
								SCALE_FACTOR_MINUS_1),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.HUMIDITY_CONTAINER, new UnsignedWordElement(1040), SCALE_FACTOR_MINUS_1),
						m(HuaweiBattery.ChannelId.MAXIMUM_LIMIT_DYNAMIC_CURRENT_HIGH_RES, new SignedWordElement(1041),
								SCALE_FACTOR_2), //
						m(HuaweiBattery.ChannelId.MINIMUM_LIMIT_DYNAMIC_CURRENT_HIGH_RES, new SignedWordElement(1042),
								SCALE_FACTOR_2), //
						m(HuaweiBattery.ChannelId.FULL_CYCLE_COUNT, new UnsignedWordElement(1043)), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.OPERATING_TIME_COUNT, new UnsignedDoublewordElement(1044)),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.COM_PRO_VERSION, new UnsignedDoublewordElement(1046)),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.SERIAL_NUMBER, new UnsignedDoublewordElement(1048)),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(HuaweiBattery.ChannelId.SOFTWARE_VERSION, new UnsignedDoublewordElement(1050)) //
				));
	}
