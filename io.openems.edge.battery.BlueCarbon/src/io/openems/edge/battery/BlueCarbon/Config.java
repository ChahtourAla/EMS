...
@ObjectClassDefinition(//
		name = "Battery Blue Carbon", //
		description = "Implements the Blue Carbon battery rack system.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Battery Blue Carbon [{id}]";
