...
@ObjectClassDefinition(//
		name = "Battery Felicity", //
		description = "Implements the Felicity battery rack system.")
@interface Config {
	...
	String webconsole_configurationFactory_nameHint() default "Battery Felicity [{id}]";
