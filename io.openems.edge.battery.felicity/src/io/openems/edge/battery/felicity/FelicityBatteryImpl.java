...
import io.openems.edge.battery.felicity.enums.BmsState;
import io.openems.edge.battery.felicity.enums.State;
...
public class FelicityBatteryImpl extends AbstractOpenemsModbusComponent implements FelicityBattery, Battery, ModbusComponent, OpenemsComponent, EventHandler, ModbusSlave, StartStoppable {
	
	private static final Integer OPEN_CONTACTORS = 0;
	private static final Integer CLOSE_CONTACTORS = 4;

	private final Logger log = LoggerFactory.getLogger(FelicityBatteryImpl.class);
	...
	public FelicityBatteryImpl() {
		super(//
				OpenemsComponent.ChannelId.values(), //
				ModbusComponent.ChannelId.values(), //
				Battery.ChannelId.values(), //
				StartStoppable.ChannelId.values(), //
				FelicityBattery.ChannelId.values() //
		);
	}
	...
	private void clearError() {
		BooleanWriteChannel clearErrorChannel = this.channel(FelicityBattery.ChannelId.BMS_STATE_COMMAND_CLEAR_ERROR);
		try {
	...
	private boolean isSystemRunning() {
		EnumReadChannel bmsStateChannel = this.channel(FelicityBattery.ChannelId.BMS_STATE);
	...
	private void startSystem() {
		...
		IntegerWriteChannel commandChannel = this.channel(FelicityBattery.ChannelId.BMS_STATE_COMMAND);
		try {
	...
	private void setStateMachineState(State state) {
		this.state = state;
		this.channel(FelicityBattery.ChannelId.STATE_MACHINE).setNextValue(this.state);
	}
	...
	protected ModbusProtocol defineModbusProtocol() throws OpenemsException {
		...
		return new ModbusProtocol(this, //
				...
				new FC16WriteRegistersTask(1399, //
						m(FelicityBattery.ChannelId.HEART_BEAT, new UnsignedWordElement(1399)), //
						m(FelicityBattery.ChannelId.BMS_STATE_COMMAND, new UnsignedWordElement(1400)), //
						m(FelicityBattery.ChannelId.OPERATING_STATE_INVERTER, new UnsignedWordElement(1401)), //
						m(FelicityBattery.ChannelId.DC_LINK_VOLTAGE, new UnsignedWordElement(1402), SCALE_FACTOR_MINUS_1), //
						m(FelicityBattery.ChannelId.DC_LINK_CURRENT, new UnsignedWordElement(1403)), //
						m(FelicityBattery.ChannelId.OPERATION_MODE_REQUEST_GRANTED, new UnsignedWordElement(1404)), //
						m(FelicityBattery.ChannelId.OPERATION_MODE_REQUEST_CANCELED, new UnsignedWordElement(1405)), //
						m(new BitsWordElement(1406, this) //
								.bit(1, FelicityBattery.ChannelId.CONNECTION_STRATEGY_HIGH_SOC_FIRST) //
								.bit(0, FelicityBattery.ChannelId.CONNECTION_STRATEGY_LOW_SOC_FIRST) //
						), //
						m(FelicityBattery.ChannelId.SYSTEM_TIME, new UnsignedDoublewordElement(1407)) //
				),

				new FC4ReadInputRegistersTask(999, Priority.HIGH,
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.LIFE_SIGN, new UnsignedWordElement(999)),
						m(FelicityBattery.ChannelId.BMS_STATE, new UnsignedWordElement(1000)), //
						m(FelicityBattery.ChannelId.ERROR_BITS_1, new UnsignedWordElement(1001)), //
						m(FelicityBattery.ChannelId.ERROR_BITS_2, new UnsignedWordElement(1002)), //
						m(FelicityBattery.ChannelId.WARNING_BITS_1, new UnsignedWordElement(1003)), //
						m(FelicityBattery.ChannelId.WARNING_BITS_2, new UnsignedWordElement(1004)), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.INFO_BITS, new UnsignedWordElement(1005)),
						m(FelicityBattery.ChannelId.MAXIMUM_OPERATING_CURRENT, new SignedWordElement(1006)), //
						m(FelicityBattery.ChannelId.MINIMUM_OPERATING_CURRENT, new SignedWordElement(1007)), //
						...
						m(FelicityBattery.ChannelId.MAXIMUM_LIMIT_DYNAMIC_VOLTAGE, new UnsignedWordElement(1012),
								SCALE_FACTOR_MINUS_1), //
						m(FelicityBattery.ChannelId.MINIMUM_LIMIT_DYNAMIC_VOLTAGE, new UnsignedWordElement(1013),
								SCALE_FACTOR_MINUS_1), //
						m(FelicityBattery.ChannelId.NUMBER_OF_STRINGS_CONNECTED, new UnsignedWordElement(1014)), //
						m(FelicityBattery.ChannelId.NUMBER_OF_STRINGS_INSTALLED, new UnsignedWordElement(1015)), //
						m(FelicityBattery.ChannelId.SOC_ALL_STRINGS, new UnsignedWordElement(1016), SCALE_FACTOR_MINUS_2), //
						m(Battery.ChannelId.SOC, new UnsignedWordElement(1017), SCALE_FACTOR_MINUS_2), //
						m(FelicityBattery.ChannelId.REMAINING_CHARGE_CAPACITY, new UnsignedWordElement(1018)), //
						m(FelicityBattery.ChannelId.REMAINING_DISCHARGE_CAPACITY, new UnsignedWordElement(1019)), //
						m(FelicityBattery.ChannelId.REMAINING_CHARGE_ENERGY, new UnsignedWordElement(1020)), //
						m(FelicityBattery.ChannelId.REMAINING_DISCHARGE_ENERGY, new UnsignedWordElement(1021)), //
						m(FelicityBattery.ChannelId.NOMINAL_ENERGY, new UnsignedWordElement(1022)), //
						m(FelicityBattery.ChannelId.TOTAL_ENERGY, new UnsignedWordElement(1023)), //
						m(FelicityBattery.ChannelId.NOMINAL_CAPACITY, new UnsignedWordElement(1024)), //
						...
						m(FelicityBattery.ChannelId.DC_VOLTAGE_AVERAGE, new UnsignedWordElement(1028),
								SCALE_FACTOR_MINUS_1)), //
				new FC4ReadInputRegistersTask(1029, Priority.HIGH, //
						m(new SignedWordElement(1029)) //
								.m(FelicityBattery.ChannelId.DC_CURRENT, SCALE_FACTOR_MINUS_1) //
								.m(Battery.ChannelId.CURRENT, SCALE_FACTOR_MINUS_1) //
								.build()), //
				new FC4ReadInputRegistersTask(1030, Priority.HIGH, //
						m(FelicityBattery.ChannelId.AVERAGE_TEMPERATURE, new SignedWordElement(1030))), //
				new FC4ReadInputRegistersTask(1031, Priority.HIGH, //
						m(new SignedWordElement(1031)) //
								.m(FelicityBattery.ChannelId.MINIMUM_TEMPERATURE, DIRECT_1_TO_1) //
				...
				new FC4ReadInputRegistersTask(1032, Priority.HIGH, //
						m(new SignedWordElement(1032)) //
								.m(FelicityBattery.ChannelId.MAXIMUM_TEMPERATURE, DIRECT_1_TO_1) //
				...
				new FC4ReadInputRegistersTask(1033, Priority.HIGH,
						...
						m(FelicityBattery.ChannelId.AVERAGE_CELL_VOLTAGE, new UnsignedWordElement(1035)), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.INTERNAL_RESISTANCE, new UnsignedWordElement(1036)),
						m(FelicityBattery.ChannelId.INSULATION_RESISTANCE, new UnsignedWordElement(1037), DIRECT_1_TO_1), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.CONTAINER_TEMPERATURE, new UnsignedWordElement(1038),
								SCALE_FACTOR_MINUS_1),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.AMBIENT_TEMPERATURE, new UnsignedWordElement(1039),
								SCALE_FACTOR_MINUS_1),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.HUMIDITY_CONTAINER, new UnsignedWordElement(1040), SCALE_FACTOR_MINUS_1),
						m(FelicityBattery.ChannelId.MAXIMUM_LIMIT_DYNAMIC_CURRENT_HIGH_RES, new SignedWordElement(1041),
								SCALE_FACTOR_2), //
						m(FelicityBattery.ChannelId.MINIMUM_LIMIT_DYNAMIC_CURRENT_HIGH_RES, new SignedWordElement(1042),
								SCALE_FACTOR_2), //
						m(FelicityBattery.ChannelId.FULL_CYCLE_COUNT, new UnsignedWordElement(1043)), //
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.OPERATING_TIME_COUNT, new UnsignedDoublewordElement(1044)),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.COM_PRO_VERSION, new UnsignedDoublewordElement(1046)),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.SERIAL_NUMBER, new UnsignedDoublewordElement(1048)),
						// not defined by "BCS_HL-SW_Operating-Instructions_V1.0.2_under_work_ChL.pdf"
						m(FelicityBattery.ChannelId.SOFTWARE_VERSION, new UnsignedDoublewordElement(1050)) //
				));
	}
